...
| Declared-but-gated slots (9 future lobes) | genuinely declared-but-gated, mechanism only | No struct fields added for any of the nine — a documented extension-point comment only, matching D13/D7's own "future task lands here" idiom already used three times in this codebase. |
